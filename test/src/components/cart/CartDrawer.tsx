            ...
            {isOpen && (
                <>
                    ...
                    >
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 flex flex-col justify-between py-1">
                                            <div className="flex justify-between items-start">
                                                <h3 className="font-serif font-bold text-amber-950 line-clamp-2 leading-tight">
                                                    {item.name}
                                                </h3>
                                                <button
                        ...
                        {/* Footer */}
                        {items.length > 0 && (
                            <div className="p-6 border-t border-amber-900/10 bg-white/50 backdrop-blur-md">
                                <div className="flex justify-between items-center mb-6">
                                    <span className="text-amber-900/60 font-medium">Subtotal</span>
