                        ...
                        {items.map(item => (
                            <div key={item.id} className="flex gap-4 items-center">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-amber-900/60">{item.qty} x {formatCurrency(item.price)}</div>
                                </div>
                                <div className="font-bold text-amber-900">{formatCurrency(item.price * item.qty)}</div>
                            </div>
                        ))}
                    </div>
