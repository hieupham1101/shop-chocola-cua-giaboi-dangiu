                                    ...
                                    <AnimatePresence mode="wait">
                                        ...
                                        {activeIndex === index && (
                                            ...
                                            >
                                                ...
                                                >
                                                    <h1 className="text-5xl lg:text-6xl font-serif font-bold text-white drop-shadow-lg leading-tight mb-4">
                                                        {banner.title}
                                                    </h1>
                                                    <p className="text-lg lg:text-xl text-white/90 max-w-xl drop-shadow-md">
                                                        {banner.subtitle}
                                                    </p>
                                                </motion.div>
